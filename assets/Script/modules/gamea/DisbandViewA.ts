 ...
 * 设置界面
 */
export class DisbandViewA extends cc.Component {
    ...
    private msgDisbandNotify: proto.pokerface.MsgDisbandNotify;

    public saveRoomView(room: RoomInterfaceA, msgDisbandNotify: proto.pokerface.MsgDisbandNotify): void {
        this.room = room;
    ...
    public updateView(): void {
        ...
        // 更新按钮
        const disbandStateEnum = proto.pokerface.DisbandState;
    ...
    protected onLoad(): void {
        ...
        const view = fgui.UIPackage.createObject("runfast", "disband_room").asCom;
        this.view = view;
    ...
    private updateTexts(msgDisbandNotify: proto.pokerface.MsgDisbandNotify): void {
