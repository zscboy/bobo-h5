export namespace proto {
	export namespace lobby {
		...
		interface IMsgReleaseRoomReq {
			roomID: string;
			roomType?: number;
		}

		class MsgReleaseRoomReq implements IMsgReleaseRoomReq {
			public roomID: string;
			public roomType: number;
			constructor(properties?: lobby.IMsgReleaseRoomReq);
			public static encode(message: MsgReleaseRoomReq): ByteBuffer;
			public static decode(reader: Uint8Array | ByteBuffer): MsgReleaseRoomReq;
		}

		interface IMsgReleaseRoomRsp {
			result: number;
			roomID?: string;
			retMsg?: string;
		}

		class MsgReleaseRoomRsp implements IMsgReleaseRoomRsp {
			public result: number;
			public roomID: string;
			public retMsg: string;
			constructor(properties?: lobby.IMsgReleaseRoomRsp);
			public static encode(message: MsgReleaseRoomRsp): ByteBuffer;
			public static decode(reader: Uint8Array | ByteBuffer): MsgReleaseRoomRsp;
		}
		...
		interface IMsgUpdateUserMoney {
			diamond: number;
			activityType?: number;
		}

		class MsgUpdateUserMoney implements IMsgUpdateUserMoney {
			public diamond: number;
			public activityType: number;
			constructor(properties?: lobby.IMsgUpdateUserMoney);
			public static encode(message: MsgUpdateUserMoney): ByteBuffer;
			public static decode(reader: Uint8Array | ByteBuffer): MsgUpdateUserMoney;
		}

		interface IMsgAccReplayRoom {
			replayRoomBytes: Uint8Array;
			recordRoomType: number;
		}

		class MsgAccReplayRoom implements IMsgAccReplayRoom {
			public replayRoomBytes: Uint8Array;
